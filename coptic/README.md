...
Все права на использованные материалы и источники принадлежат https://github.com/CopticScriptorium/
и https://copticscriptorium.org/.
...
Этот корпус участвует в методах SVD и CBOW для преобразования слова в векторные представления.
